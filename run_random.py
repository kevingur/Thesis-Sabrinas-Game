...
from random_algorithm  import random_algorithm, random_unstuck  

GRIDS_ROOT = "grids"          
N_RUNS = 30              
OUT_CSV = "random_results.csv"

ALGORITHMS = [
    ("random",          random_algorithm, ["6x6", "8x8", "12x12"]),
    ("random_unstuck",  random_unstuck,   ["6x6", "8x8", "12x12", "16x16", "18x18"]),
]
